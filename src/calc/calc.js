/*eslint-disable */
// Расчета расстояния на основе RSSI:
function calculateDistance(rssi, txPower, n = 2.0) {
  return Math.pow(10, (txPower - rssi) / (10 * n));
}

// Расчет  RSSI от расстояния
function calculateRSSI(distance, rssiAtOneMeter = -59, pathLossExponent = 2) {
  const rssi = rssiAtOneMeter - 10 * pathLossExponent * Math.log10(distance);
  return rssi;
}
